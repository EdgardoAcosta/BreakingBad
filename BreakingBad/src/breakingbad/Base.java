...
public class Base {
    ...
    public boolean intersecta1 (Base obj) {
        if (obj instanceof Base)
        {
            Rectangle rctEste = new Rectangle(this.getPosX(), this.getPosY(), this.getAncho(), this.getAlto()); 
            Base Temporal = (Base) obj;
            Rectangle rctParam = new Rectangle(Temporal.getPosX(), Temporal.getPosY(), Temporal.getAncho(), Temporal.getAlto());
