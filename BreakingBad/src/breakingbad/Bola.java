...
//        Image balon1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("images/balon1.gif"));
        Image balon2 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("bola3.png"));
        Image balon3 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("bola4.png"));
        Image balon4 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("bola1.png"));
        Image balon5 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("bola2.png"));
